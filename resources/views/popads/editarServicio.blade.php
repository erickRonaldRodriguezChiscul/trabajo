                ...
                <div class="row">
                    <div class="col-md-4">
                        ...
                        <div class="form-group">
                            <label for="nombreServicioEditar">Nombre</label>
                            <input id="nombreServicioEditar" type="text" class="form-control" name="nombreServicioEditar" value="" autofocus>
                            <div class="nombreServicioEditar">
                            </div>
                        </div>
                    </div>
                    <div class="col-md-4">
                        <div class="form-group">
                            <label for="importeServicioEditar">Importe</label>
                            <input id="importeServicioEditar" type="text" class="form-control" name="importeServicioEditar" onkeypress="return filterFloat(event,this);">
                            <div class="importeServicioEditar">
                            </div>
                        </div>
                    </div>
                    <div class="col-md-4">
